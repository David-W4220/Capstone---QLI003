                        ...
                        <div className="grid grid-cols-1 gap-3">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="bg-gray-50 p-3 rounded">
                                    <h3 className="text-xs font-medium text-gray-500">Equipment ID</h3>
                                    <p className="text-sm font-semibold text-gray-900">{equipment.ID}</p>
                                </div>
                                <div className="bg-gray-50 p-3 rounded">
                                    <h3 className="text-xs font-medium text-gray-500">Location</h3>
                                    <p className="text-sm font-semibold text-gray-900">{equipment.Alpha_Loc}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="bg-gray-50 p-3 rounded">
                                    <h3 className="text-xs font-medium text-gray-500">Current Stock</h3>
                                ...
                                <div className="bg-gray-50 p-3 rounded">
                                    <h3 className="text-xs font-medium text-gray-500">Threshold</h3>
                                    <p className="text-sm font-semibold text-gray-900">{equipment.Threshold}</p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="bg-gray-50 p-3 rounded">
                                    <h3 className="text-xs font-medium text-gray-500">Reorder Link/Primary Qty</h3>
                                    <p className="text-sm text-gray-900">
                                        {equipment.ReodrLk_Pri_Qty || 'Not specified'}
                                    </p>
                                </div>
                                <div className="bg-gray-50 p-3 rounded">
                                    <h3 className="text-xs font-medium text-gray-500">Buy Quantity</h3>
                                    <p className="text-sm text-gray-900">
